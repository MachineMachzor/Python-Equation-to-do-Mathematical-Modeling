...
#plt string argument third parameter format
# fmt = '[line style][marker][color]'
...
areaRounded = np.array(areaRounded) #Areas predicted and rounded


for xy in zip(days1DArray, areaRounded): #Print the points for the model
	plt.annotate('(%s, %s)' % xy, xy=xy, textcoords='data')
